...
import { listDeletedEngagements } from "@/lib/api";
...
export default async function BinPage() {
  ...
  try {
    engagements = await listDeletedEngagements();
  } catch (e) {
    error = e instanceof Error ? e.message : "Failed to load deleted engagements";
  }

  return <BinList engagements={engagements} error={error} />;
}
