...
LAYER_CHECKS = [
    ...
    {"layer": 4, "key": "has_cdp_disclosure", "domain": "carbon",
     ...
     "title_bad": "No CDP disclosure found (CDP registry)",
     "severity_bad": "medium", "severity_good": "positive"},
    {"layer": 4, "key": "has_sbti_target", "domain": "carbon",
     "check": lambda v: bool(v),
     "title_good": "Science Based Target validated (SBTi registry)",

     "title_bad": "No Science Based Target found (SBTi registry)",
     "severity_bad": "medium", "severity_good": "positive"},
    {"layer": 4, "key": "carbon_trust_certified", "domain": "carbon",
     "check": lambda v: bool(v),
     "title_good": "Carbon Trust certified",
     "title_bad": "No Carbon Trust certification found (registry)",
     "severity_bad": "info", "severity_good": "positive"},
    ...
    {"layer": 5, "key": "modern_slavery_statement", "domain": "labour",
     "check": lambda v: bool(v),
     "title_good": "Modern Slavery Statement found (gov.uk registry)",
     "title_bad": "No Modern Slavery Statement found (gov.uk registry)",
     "severity_bad": "medium", "severity_good": "positive"},
